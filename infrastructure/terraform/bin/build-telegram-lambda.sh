...
cp -R "${REPO_ROOT}/src/dao" "${REPO_ROOT}/src/models" "${REPO_ROOT}/src/services" "${REPO_ROOT}/src/scoring" "${REPO_ROOT}/src/utils" "${REPO_ROOT}/src/kb" "${REPO_ROOT}/src/web" "${REPO_ROOT}/src/fixtures" "${REPO_ROOT}/src/jobs" "${REPO_ROOT}/src/clients" "${BUILD_DIR}/src/"
